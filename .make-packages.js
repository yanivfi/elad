...
let rootPackageJson = Object.assign({}, pkg, {
  ...
  browser: './bundles/elad.cms.umd.min.js'
});
...
fs.copySync('src/cms/package.json', PKG_ROOT + '/cms/package.json');
...
fs.removeSync(CJS_PKG + '/umd.js');
fs.removeSync(CJS_PKG + '/umd.js.map');
fs.removeSync(ESM5_PKG + '/umd.js');
fs.removeSync(ESM5_PKG + '/umd.js.map');
fs.removeSync(ESM2015_PKG + '/umd.js');
fs.removeSync(ESM2015_PKG + '/umd.js.map');
fs.removeSync(TYPE_PKG + '/umd.d.ts');
